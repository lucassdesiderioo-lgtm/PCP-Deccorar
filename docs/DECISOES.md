...
| 17/09/2026 | A etiqueta do kit é impressa por **PDF no tamanho exato**, não por ZPL enviado à impressora | A Zebra ZD220 está ligada por USB no computador, não na rede: o servidor não fala com ela. A página já nasce com 100 × 35 mm, então não há margem nem escala para o operador errar | Lucas | `docs/specs/GERADOR-ETIQUETA-KIT.md` STATUS · `kit_pdf.js` |
