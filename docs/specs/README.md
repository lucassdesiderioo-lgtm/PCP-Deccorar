...
| `ESTOQUE-LIVRO-E-CONFERENCIA.md` | **Em construção** · fases 0 e 1 no ar (21/09) · **fase 2 em código (26/09)** — a conferência em três papéis, §6.4 decidida (espera) · fases 3 e 4 planejadas |
