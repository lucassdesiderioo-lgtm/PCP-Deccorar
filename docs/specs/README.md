...
| Spec | Status |
|---|---|
| `SOBMEDIDA-PEDIDO-REVENDA.md` | **Em construção** · módulo sob medida (`tecido/`) · **fase 1 em produção e conferida (22/09 — dez persianas reais no corte e dez no preço, as vinte bateram)** · fases 2–8 planejadas · as duas decisões da §8 anteriores à fase 1 estão respondidas |
