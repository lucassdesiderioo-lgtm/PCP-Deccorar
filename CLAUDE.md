...
| 10 | Sem testes automatizados na maior parte — hoje há `teste_parse.js` (14 casos), `teste_carga.js` (46), `teste_divergencia.js` (26) `teste_estoque.js` (56), `teste_cruzamento.js` (14), `teste_etiqueta.js` (20), `teste_ficha.js` (40) e `teste_ordem_dia.js` (16); o resto não tem | Médio a longo prazo |
...
`ger_route.js`** — os 56 casos travam a conta única nas quatro telas, o sob
